defmodule MBTAV3API.Schedules.HoursOfOperation do
  @moduledoc """
  MBTA serviceh ours of operation.
  """

  alias MBTAV3API.Routes.Route
  alias MBTAV3API.Schedules
  alias MBTAV3API.Schedules.Departures
  ...
  * special service
  ...
  @spec hours_of_operation(
          Route.id_t() | [Route.id_t()],
          Date.t(),
          Route.gtfs_route_desc()
        ) ::
          t | {:error, any}
  def hours_of_operation(route_id_or_ids, date \\ DateUtil.service_date(), description) do
    ...
    params
    |> Task.async_stream(&Schedules.all/1, on_timeout: :kill_task)
  ...
  * ...
  """
  @spec api_params([Route.id_t()], Date.t(), atom(), [Date.t()]) ::
          Keyword.t()
