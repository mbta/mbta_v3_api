defmodule MBTAV3API.Services.Service do
  ...
  @spec special_service_dates(Route.id_t() | [Route.id_t()]) :: [Date.t()]
  ...
  defp all_valid_dates_for_service(%__MODULE__{
    ...
    |> Enum.reject(fn date ->
      ...
      end || Enum.member?(removed_dates, date)
    end)
