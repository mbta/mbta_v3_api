defmodule MBTAV3API.Predictions.StreamParser do
  @moduledoc """
  ...
  alias JsonApi.Item
  alias MBTAV3API.Predictions.{Parser, Prediction}
  ...
  def parse(%Item{} = item) do
    ...
    %Prediction{
      ...
      time: SchedulesParser.display_time(arrival, departure, route),
      route: route,
      stop: StopsRepo.get_parent(stop),
