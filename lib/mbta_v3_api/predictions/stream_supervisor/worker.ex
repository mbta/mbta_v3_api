defmodule MBTAV3API.Predictions.StreamSupervisor.Worker do
  ...
  def init({keys, filters}) do
    ...
    Supervisor.init(
      [
        ...
        {MBTAV3API.Stream, name: api_stream_name, subscribe_to: sses_stream_name},
        {MBTAV3API.Predictions.Stream,
  ...
  defp sses_opts(filters) do
    ...
    sses_opts =
      MBTAV3API.Stream.build_options(
