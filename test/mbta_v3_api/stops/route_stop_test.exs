defmodule MBTAV3API.Stops.RouteStopTest do
  ...
  describe "list_from_route_patterns/2" do
    ...
    #   actual = RouteStop.list_from_route_patterns(route_patterns_with_stops, @green_route, 0, true)
    ...
    #   actual = RouteStop.list_from_route_patterns(route_patterns_with_stops, @newburyport_route, 0)
    ...
    #   actual = RouteStop.list_from_route_patterns(route_patterns_with_stops, @newburyport_route, 1)
    ...
    #   assert_branch_names(
    #     RouteStop.list_from_route_patterns(route_pattern_with_stops_0, @green_b_route, 0, true),
    #     [
    #       "Green-B",
    #       "Green-B",
    #       "Green-B"
    ...
    #   assert_branch_names(
    #     RouteStop.list_from_route_patterns(route_pattern_with_stops_1, @green_b_route, 1, true),
    #     [
    #       "Green-B",
    #       "Green-B",
    #       "Green-B"
