defmodule MBTAV3API.Predictions.RepoTest do
  @moduledoc false
  use ExUnit.Case
  ...
  describe "all/1" do
    ...
    #     for stop <- stops do
    #       assert %{route: %Route{id: "Red"}, stop: %Stop{id: "place-sstat"}} = stop
    #     end
    #   end
  ...
  describe "has_trip?/1" do
    ...
    test "returns true for items with trips" do
      trip = %Item{relationships: %{"trip" => [%Item{id: "1"}]}}
      assert Repo.has_trip?(trip) == true
    end
  end
  ...
  describe "load_from_other_repos/1" do
    ...
    #              departing?: false
    #            }
    #          ] = Repo.load_from_other_repos([prediction])
    # end
