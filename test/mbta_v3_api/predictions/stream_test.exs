defmodule MBTAV3API.Predictions.StreamTest do
  use ExUnit.Case

  alias ExUnit.CaptureLog
  alias JsonApi.{Error, Item}
  alias MBTAV3API.Predictions.Stream
  ...
  describe "start_link/1" do
    test "starts a GenServer that can recieve stream events and call a broadcast function" do
      ...
      broadcast_fn = fn MBTAV3API.Predictions.PubSub, "predictions", :broadcast ->
  ...
  describe "handle_events/3" do
    test "can log stream errors" do
      ...
      assert log =~ "[error]"
      assert log =~ "module=Elixir.MBTAV3API.Predictions.Stream"
    ...
    test "can log broadcast errors" do
      ...
      broadcast_fn = fn MBTAV3API.Predictions.PubSub, "predictions", _ ->
